...
<nav class="navbar navbar-expand-lg navbar-dark bg-black">
    <a class="navbar-brand" href="/">
        <img src="Rabux mini.png" width="60" class="rounded-circle">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav ml-auto">
            ...
            <?php }else{ ?>
                ...
                <a class="nav-item nav-link active" href="https://www.facebook.com/profile.php?id=100086204135098" target="_blank">
