        ...
        <div class="col-12">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100 image_show" src="RaBux.png">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100 image_show" src="lala2.png">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100 image_show" src="netflix.png">
                    </div>
                </div>
            ...
            <div class="mt-3">
                ...
                <h4 class="text-center">ยังไม่มีครับ</h4>
            </div>
            <div class="row mt-3">
